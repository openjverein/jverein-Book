...
* über den Zusatzbetrag zuordnen Dialog aus dem Mitglied Menü (siehe [Mitglied Zusatzbetrag zuordnen](../../3.2/mitglieder/content/mitglieder.md))
* beim Anlegen eines Zusatzbetrags beim Mitglied (siehe [Zusatzbeträge](../../3.2/mitglieder/content/zusatzbeitraege.md))
* beim Speichern eines Zusatzbetrags (siehe [Zusatzbeträge](../../3.2/mitglieder/zusatzbetrage.md))
...
Die Übersicht lässt sich über den Button Vorlagen in der Zusatzbeträge Liste aufrufen (siehe [Zusatzbeträge](../../3.2/mitglieder/zusatzbetrage.md)) .
