...
Auflistung aller Abrechnungsläufe. Mit einem Rechtsklick kann ein Lauf gelöscht werden oder es können [Pre-Notification](../../3.0/druckmail/pre-notification.md) ausgeben werden.
...
Über den "Neu" Button können neue Abrechnungsläufe erzeugt werden (siehe [Abrechnung](../../3.0/abrech/abrechnung.md)).
