...
Bei der Mitgliederliste CSV werden sämtliche vorhandenen Mitglieder-Eigenschaften inklusive selbst definierte [Zusatzfelder](../../3.2/administration/mitglieder/felddefinition.md) in die CSV-Datei exportiert.
...
Dazu ist zunächst unter [Einstellungen->Dateinamen](../../4.0/administration/einstellungen/dateinamen.md) ein Verzeichnis zu wählen, in dem alle selbst erstellten Vorlagen gespeichert werden.
