...
Im Prinzip gibt es hier die gleichen Funktionen wie auch im Buchungen View, allerdings reduziert um nicht benötigte Optionen. Der View wurde eingeführt um den [Buchungen](../../4.0/buchf/buchungen.md) View nicht unnötig mit Anlagenkonten zu überfüllen.
...
![](<../../../.gitbook/assets/AnlagenbuchungenListeView (3).png>)
