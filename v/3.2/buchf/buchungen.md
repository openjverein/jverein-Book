...
* Hibiscus-Import: Import von Buchungen aus Hibiscus. Siehe [Buchungsübernahme](../../4.0/buchf/buchungsubernahme.md)
* Import: Import von Buchungen aus einer CSV Datei. Siehe [Buchungsimport](../../4.0/buchf/buchungsimport.md)
...
* Gegenbuchung: Öffnet die Detailansicht für eine neue Buchung um eine Gegenbuchung zur selektierten Buchung zu erstellen Der Menüpunkt ist nur verfügbar wenn die Buchungsart der selektierten Buchung der Art "Umbuchung" ist. In der Gegenbuchung ist der negative Betrag der selektierten Buchung eingetragen. Nach Auswahl der Aktion wird erst ein Dialog zur Auswahl des Gegenkontos geöffnet. Dieser Dialog wird übersprungen wenn in der Konfiguration eines Kontos die Buchungsart der selektierten Buchung konfiguriert ist. In diesem Fall wird sofort das entsprechende Konto eingetragen. Siehe [Konten](../../4.0/buchf/konten.md).
* Splitbuchung: Erzeugt eine Splitbuchung. Siehe [Splittbuchungen](../../4.0/buchf/splittbuchungen.md)
...
Buchungen können nur neu aufgenommen, geändert oder gelöscht werden, wenn sie nicht durch einen [Jahresabschluss](../../4.0/buchf/jahresabschluss.md) abgeschlossen wurden.
...
Siehe auch [Sollbuchungen](../../4.0/mitglieder/mitgliedskonto.md), [Splittbuchungen](../../4.0/buchf/splittbuchungen.md)
