...
* Anzeige der Anlagenkonten und AfA Buchungen in einem eigenen [Anlagenbuchungen View](../../v3.0.x/buchf/anlagenbuchungen.md)
* Erstellung eines [Anlagenverzeichnisses](../../v3.0.x/buchf/anlagenverzeichnis.md)
...
* Unter [Anfangsbestände](../../v3.0.x/buchf/anfangsbestand.md) einen Eintrag für den ersten Tag des aktuellen Geschäftsjahres erstellen und dort den aktuellen Buchungswert der Anlage eintragen
