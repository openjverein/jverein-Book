...
* Import: Import von Buchungen aus einer CSV Datei. Siehe [Buchungsimport](../../v3.0.x/buchf/buchungsimport.md)
...
* Splitbuchung: Erzeugt eine Splitbuchung. Siehe [Splittbuchungen](../../v3.0.x/buchf/splittbuchungen.md)
...
Siehe auch [Sollbuchungen](../mitglieder/mitgliedskonto.md), [Splittbuchungen](../../v3.0.x/buchf/splittbuchungen.md)
