...
![](../../v3.1.x/druckmail/img/LastschriftenListeView.png)
...
Bevor Pre-Notifications gedruckt werden können muss zunächst ein [Formular](../../v3.0.x/administration/mitglieder/formulare.md) dafür angelegt werden.
