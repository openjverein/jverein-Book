...
Im Betreff und im Text können Variable eingefügt werden, die beim Mailversand mit den konkreten Daten gefüllt werden. Mit Rechtsklick auf den Empfänger oder über den Button können die verfügbaren Variablen und ihre Belegung angezeigt werden.
