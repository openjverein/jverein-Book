...
Eine Unterscheidung von Geldkonten und Fremdkapital ist nur nötig wenn das Feature [Mittelverwendung](../../v3.0.x/buchf/mittelverwendung.md) benutzt werden soll.
...
Gemeinnützige Vereine müssen ihre Einnahmen im aktuellen und den zwei folgenden Jahren ausgegeben haben (zeitnahe Verwendung). Dieses müssen sie dem Finanzamt nachweisen, siehe [Mittelverwendung](../../v3.0.x/buchf/mittelverwendung.md). Sie dürfen aber Rücklagen bilden. Diese sind der zeitnahen Verwendung entzogen.
...
Diese Konten dienen nur zur Dokumentation der vorhanden Rücklagen. Sie werden aber bei der [Mittelverwendung](../../v3.0.x/buchf/mittelverwendung.md) berücksichtigt.
...
![](../../v3.0.x/buchf/img/AnlagenkontoView.png)
...
* Anlagenzweck: Dieses Attribut wird nur angezeigt wenn [Mittelverwendung](../../v3.0.x/buchf/mittelverwendung.md) aktiviert wurde. Hier wird konfiguriert, ob die Anlage nutzungsgebunden ist oder zweckfremd verwendet wird
